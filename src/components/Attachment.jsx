...
const Attachment = () => (
  <div className="flex flex-col w-full space-y-5 py-10 px-5 mb-5 rounded-lg bg-rowTable">
    <div className="mb-7">
      <p>Attachments</p>
    </div>
    ...
    <div className="flex flex-col md:flex-row md:items-center md:justify-between space-y-4">
      <div className="space-y-2">
        <h1 className=" text-white font-roboto font-bold text-xs">
          Cover Letter
        </h1>
        <p className="text-gray-400 font-roboto font-normal text-xs">
          No files here
    ...
    <div className="flex flex-col md:flex-row md:items-center md:justify-between space-y-4">
      <div className="space-y-2">
        <h1 className=" text-white font-roboto font-bold text-xs">Portfolio</h1>
        <p className="text-gray-400 font-roboto font-normal text-xs">
          No files here
        </p>
      </div>
